...
void main() {
  ...
  final _initialState = AppState(
    ...
    serviceState: ServiceState(
        ...
        description: "",
        availability: false,
        actionList: [ObjectState()],
        categoryList: [ObjectState()],
        externalCategoryList: [ObjectState()],
        positionList: [ObjectState()],
        visibility: "Visible",
        constraintList: [ObjectState()],
        tagList: [ObjectState()],
        price: 0.00,
        write_permission: [ObjectState()],
        pipelineList: [ObjectState()]),
    pipeline: Pipeline(
      name: "",
      description: "",
    ),
