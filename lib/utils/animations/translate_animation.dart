...
class TranslateRotatingPlain extends StatefulWidget {
  const TranslateRotatingPlain({
    Key key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  _TranslateRotatingPlainState createState() => _TranslateRotatingPlainState();
}

class _TranslateRotatingPlainState extends State<TranslateRotatingPlain> with SingleTickerProviderStateMixin {
          ...
          child: Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/img/animation/translate.png')
              )
            ),
          ),
        ),
