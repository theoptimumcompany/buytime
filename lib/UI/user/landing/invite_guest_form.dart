...
class InviteGuestForm extends StatefulWidget {
  static String route = '/inviteGuestForm';
  String id;
  bool fromLanding;
  ...
  Widget build(BuildContext context) {
    ...
    return StoreConnector<AppState, AppState>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.booking.booking_code != '' && bookingRequest == 'send') bookingRequest = '';
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(fontFamily: BuytimeTheme.FontFamily, color: BuytimeTheme.TextBlack, fontWeight: FontWeight.w400, fontSize: 24
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  filled: true,
                                  enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.black), borderRadius: BorderRadius.all(Radius.circular(5.0))),
                                  focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.black), borderRadius: BorderRadius.all(Radius.circular(5.0))),
