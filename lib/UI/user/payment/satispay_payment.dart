...
class SatispayPayment extends StatefulWidget {
  final Function onFinish;
  bool tourist;
  OrderState orderState;
  SatispayPayment({this.onFinish, this.tourist, this.orderState});

  @override
  State<StatefulWidget> createState() {
    return SatispayPaymentState();
  }
}

class SatispayPaymentState extends State<SatispayPayment> {
