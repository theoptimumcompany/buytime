...
class _TouristSessionState extends State<TouristSession> with SingleTickerProviderStateMixin {
  ...
  void routeToAfterLogged() {
    bool reservableService = StoreProvider.of<AppState>(context).state.serviceState.switchSlots;
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ConfirmOrder(reserve: reservableService, tourist: true)),);
  }
  ...
  Future<int> signInWithGoogle(context) async {
    ...
    if (googleSignInAccount != null) {
      ...
      pr.style(message: AppLocalizations.of(context).authentication, borderRadius: 10.0, backgroundColor: Colors.white, progressWidget: CircularProgressIndicator(), elevation: 10.0, insetAnimCurve: Curves.easeInOut, progress: 0.0, maxProgress: 100.0, progressTextStyle: TextStyle(color: Colors.blue, fontSize: 13.0, fontWeight: FontWeight.w400), messageTextStyle: TextStyle(color: Colors.black, fontSize: 19.0, fontWeight: FontWeight.w600));
      await pr.show();
            ...
            child: Stack(
              children: <Widget>[
                Padding(
                  ...
                  child: Container(
                    height: autoCompleteList.length == 1
                        ? 45
                        : autoCompleteList.length == 2
                            ? 90
                            : autoCompleteList.length == 3
                                ? 135
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ///Forgot Password
                                              Container(
                                                  margin: EdgeInsets.only(top: SizeConfig.safeBlockVertical * 0.5),
