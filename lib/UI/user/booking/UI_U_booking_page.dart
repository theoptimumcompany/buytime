      ...
      children: [
        ...
        list.length >= 1
            ? Flexible(
                ...
                child: FindYourInspirationCardWidget(
                    list.length <= 2 ? SizeConfig.screenWidth / 2 - 2 : SizeConfig.screenWidth / 3 - 2, list.length <= 2 ? SizeConfig.screenWidth / 2 - 2 : SizeConfig.screenWidth / 3 - 2, list[0], true, false, [list[0].id], pos, 0, false),
              )
            : Container(),
        ...
        list.length >= 2
            ? Flexible(
                flex: 1,
                child: FindYourInspirationCardWidget(
                    list.length <= 2 ? SizeConfig.screenWidth / 2 - 2 : SizeConfig.screenWidth / 3 - 2, list.length <= 2 ? SizeConfig.screenWidth / 2 - 2 : SizeConfig.screenWidth / 3 - 2, list[1], true, false, [list[1].id], pos, 1, false),
              )
            : Container(),
        ...
        list.length == 3
            ? Flexible(
                flex: 1,
                child: FindYourInspirationCardWidget(
                    list.length <= 2 ? SizeConfig.screenWidth / 2 - 2 : SizeConfig.screenWidth / 3 - 2, list.length <= 2 ? SizeConfig.screenWidth / 2 - 2 : SizeConfig.screenWidth / 3 - 2, list[2], true, false, [list[2].id], pos, 2, false),
              )
            : Container(),
      ],
    );
    ...
    return StoreConnector<AppState, AppState>(
      ...
      onInit: (store) {
        ...
        if (store.state.serviceListSnippetListState.serviceListSnippetListState.length == 1) {
          if (store.state.serviceListSnippetListState.serviceListSnippetListState.first.businessId == null) store.state.serviceListSnippetListState.serviceListSnippetListState.removeLast();
        }
      },
                                      ...
                                      Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: CachedNetworkImage(
                                            //width: 125,
                                            imageUrl: businessState != null && businessState.wide != null
                                                ? businessState.wide
                                                  ...
                                                  builder: (context, AsyncSnapshot<QuerySnapshot> orderSnapshot) {
                                                    ...
                                                    orderList.sort((a, b) => a.date.isBefore(b.date)
                                                        ...
                                                        : a.date.isAtSameMomentAs(b.date)
                                                            ? 0
                                                            : 1);
                                                    return userOrderList.isNotEmpty
                                                        ? Column(
                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                            crossAxisAlignment: CrossAxisAlignment.start,
                                                            children: [
                                                                        ...
                                                                        child: InkWell(
                                                                            ...
                                                                            child: Container(
                                                                              ...
                                                                              child: Text(
                                                                                AppLocalizations.of(context).viewAll,
                                                                                style: TextStyle(
                                                                                    letterSpacing: SizeConfig.safeBlockHorizontal * .2, fontFamily: BuytimeTheme.FontFamily, color: BuytimeTheme.UserPrimary, fontWeight: FontWeight.w400, fontSize: 16
                                                                ...
                                                                if (StoreProvider.of<AppState>(context).state.user.getRole() == Role.user) {
                                                                  if (service.switchSlots) {
                                                                    ...
                                                                    Navigator.push(
                                                                      context,
                                                                      MaterialPageRoute(
                                                                          builder: (context) => ServiceReserve(
