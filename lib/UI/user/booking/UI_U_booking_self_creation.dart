...
class BookingSelfCreation extends StatefulWidget {
  ...
  BookingSelfCreation({this.idBusiness});
...
class _BookingSelfCreationState extends State<BookingSelfCreation> {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('ID Business da Link => ' + widget.idBusiness);

    ///TODO: ID Business dal link o QR Code
    final Stream<DocumentSnapshot> _businessStream = FirebaseFirestore.instance.collection("business").doc(widget.idBusiness).snapshots();
    ...
    return WillPopScope(
      ...
      child: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, AsyncSnapshot<DocumentSnapshot> businessSnapshot) {
          ...
          businessState = BusinessState.fromJson(businessSnapshot.data.data());
          images.add(businessState.wide);
