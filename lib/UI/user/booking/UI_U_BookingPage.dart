                                          ...
                                          child: Material(
                                            ...
                                            child: InkWell(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Text(
                                                    'Share',//AppLocalizations.of(context).somethingIsNotRight, ///TODO make it Global
                                                    style: TextStyle(
                                        ...
                                        suffixIcon: InkWell(
                                          onTap: (){
                                            ...
                                            if(searched.isNotEmpty)
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => FilterGeneral(searched: searched,)));
                                          },
                                          child: Icon(
