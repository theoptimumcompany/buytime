...
class UserNotificationListItem extends StatefulWidget {
  ...
  bool tourist;
  UserNotificationListItem(this.notificationState, this.tourist);
            ...
            child: InkWell(
              ...
              child: StoreConnector<AppState, AppState>(
                ...
                builder: (context, snapshot) {
                  return Container(
                    height:  widget.notificationState.title.split(' ').last.toLowerCase() == 'canceled' && snapshot.serviceState.switchSlots ?
                     122 :
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        widget.notificationState.title.split(' ').last.toLowerCase() == 'canceled' && snapshot.serviceState.switchSlots ?
                        Container(
                          child: Row(
                                    ...
                                    child: InkWell(
                                        onTap: () {
                                          if(widget.notificationState.notificationId != null && widget.notificationState.notificationId.isNotEmpty && widget.notificationState.data.state.serviceId.isNotEmpty){
                                            //widget.notificationState.opened = true;
                                            //StoreProvider.of<AppState>(context).dispatch(UpdateNotification(widget.notificationState));
                                            Navigator.push(context, MaterialPageRoute(builder: (context) => ServiceReserve(serviceState: snapshot.serviceState, tourist: false,)));
                                          }
                                        },
