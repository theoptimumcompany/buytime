  ...
  String whichDate(DateTime orderDate) {
    if (widget.orderState.itemList.first.time != null) {
      return currentDate == date
          ...
          : nextDate == date
              ? AppLocalizations.of(context).tomorrowLower + ' ${DateFormat('dd EEE', Localizations.localeOf(context).languageCode).format(orderDate)}, ${widget.orderState.itemList.first.time} h'
      ...
      return currentDate == date
          ...
          : nextDate == date
              ? AppLocalizations.of(context).tomorrowLower + ' ${DateFormat('dd EEE', Localizations.localeOf(context).languageCode).format(orderDate)}, ${DateFormat('HH:mm', Localizations.localeOf(context).languageCode).format(widget.orderState.date)} h'
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: FittedBox(
                        ...
                        child: Text(
                          widget.orderState.itemList.length > 1 ? Utils.retriveField(Localizations.localeOf(context).languageCode, widget.orderState.business.name) : Utils.retriveField(Localizations.localeOf(context).languageCode, widget.orderState.itemList.first.name),
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: FittedBox(
                                            fit: BoxFit.scaleDown,
                                            child: Text(
                                              widget.orderState.itemList.length > 1 ? AppLocalizations.of(context).multipleOrders : Utils.retriveField(Localizations.localeOf(context).languageCode, widget.orderState.itemList[0].name),
                                                        ...
                                                        child: Text(
                                                          () {
                                                            if (distanceFromCurrentPosition != null) {
                                                              return distanceFromCurrentPosition.toString().split('.').first.startsWith('0') && distanceFromCurrentPosition.toString().split('.').first.length != 1 ? distanceFromCurrentPosition.toString().split('.').last.substring(0, 3) + ' m' : distanceFromCurrentPosition.toStringAsFixed(1) + ' Km';
                                                            } else {
                                                              return distanceFromBusiness.toString().split('.').first.startsWith('0') && distanceFromBusiness.toString().split('.').first.length != 1 ? distanceFromBusiness.toString().split('.').last.substring(0, 3) + ' m' : distanceFromBusiness.toStringAsFixed(1) + ' Km';
                                                            }
                                                          }(),
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        ...
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                                builder: (context) => BuytimeMap(user: true, title: address, businessState: snapshot.business, serviceState: ServiceState().toEmpty()
                        ...
                        Container(
                          ...
                          child: FittedBox(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(letterSpacing: 1.5, fontFamily: BuytimeTheme.FontFamily, color: Utils.colorOrderStatus(context, widget.orderState.progress), fontWeight: FontWeight.w600, fontSize: 14
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/img/cc/$card.png'))),
                              ),

                              ///Card Name
                              Text(
                                widget.orderState.cardType != null && widget.orderState.cardType.isNotEmpty ? widget.orderState.cardType.substring(0, 1).toUpperCase() + widget.orderState.cardType.substring(1, widget.orderState.cardType.length) + '  ' : 'Sample  ',
                                style: TextStyle(fontSize: 14, fontFamily: BuytimeTheme.FontFamily, fontWeight: FontWeight.w600, color: BuytimeTheme.TextBlack),
                              ),

                              ///Ending **** ....
                              Text(
                                widget.orderState.cardType != null && widget.orderState.cardLast4Digit != null ? '**** ' + widget.orderState.cardLast4Digit : '**** 0000',
                                style: TextStyle(fontSize: 14, fontFamily: BuytimeTheme.FontFamily, fontWeight: FontWeight.w600, color: BuytimeTheme.TextBlack),
                              ),
                            ],
                          ),
                            ...
                            ? widget.orderState.itemList.length > 1
                                    ...
                                    widget.orderState.itemList.forEach((element) {
                                      tmpOrders.add(Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              element.number > 1 ? '${element.number} x ${element.name}' : '${element.number} x ${element.name}',
                                ...
                                : Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          widget.orderState.itemList.first.number > 1 ? '${widget.orderState.itemList.first.number} x ${AppLocalizations.of(context).products}' : '${widget.orderState.itemList.first.number} x ${AppLocalizations.of(context).product}',
                                          style: TextStyle(letterSpacing: 0.15, fontFamily: BuytimeTheme.FontFamily, color: BuytimeTheme.TextBlack, fontWeight: FontWeight.w500, fontSize: 14
