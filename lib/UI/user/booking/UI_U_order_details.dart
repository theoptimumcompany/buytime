...
class _OrderDetailsState extends State<OrderDetails> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    _orderStream = FirebaseFirestore.instance.collection('order').doc(widget.orderState.orderId).snapshots();
                        ...
                        return StreamBuilder<DocumentSnapshot>(
                          ...
                          builder: (context, AsyncSnapshot<DocumentSnapshot> orderSnapshot) {
                            ...
                            if (orderSnapshot != null && orderSnapshot.data != null && !orderSnapshot.hasError && orderSnapshot.connectionState != ConnectionState.waiting) {
                              ...
                              debugPrint('UI_U_order_details => PRICE: ${orderDetails.total}');
                              debugPrint('UI_U_order_details => CARD TYPE: ${orderDetails.cardType}');
                              debugPrint('UI_U_order_details => THUMBAIL: ${widget.orderState.itemList.first.thumbnail}');
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                                    ...
                                                    children: [
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          ///Address text
                                                          Container(
                                                            margin: EdgeInsets.only(left: SizeConfig.safeBlockHorizontal * 2.5, right: SizeConfig.safeBlockHorizontal * 5, top: SizeConfig.safeBlockVertical * .5),
                                                            child: FittedBox(
                                        ...
                                        Row(
                                          children: [
                                            Container(
                                              margin: EdgeInsets.only(left: SizeConfig.safeBlockHorizontal * 2.5, right: SizeConfig.safeBlockHorizontal * 1, top: orderDetails.itemList.first.time != null ? SizeConfig.safeBlockVertical * 2 : SizeConfig.safeBlockVertical * .5),
                                              child: FittedBox(
                                                fit: BoxFit.scaleDown,
                                                child: Text(
