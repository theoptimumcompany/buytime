...
class RDashboardBusinessList extends StatefulWidget {
  static String route = '/businessList';

  @override
  State<StatefulWidget> createState() => RDashboardBusinessListState();
}

class RDashboardBusinessListState extends State<RDashboardBusinessList> {
                                      ...
                                      return  Padding(
                                        ...
                                        child: new OptimumBusinessCardMediumManager(
                                          ...
                                          onBusinessCardTap: (BusinessState businessState) async{
                                            ...
                                            Navigator.push(context, MaterialPageRoute(builder: (context) => RDashboard()));
