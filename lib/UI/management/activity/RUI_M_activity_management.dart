...
//   }
//
//   final Stream<QuerySnapshot> _orderListRealtime = FirebaseFirestore.instance.collection('order').where().snapshots();
//
//   @override
...
//                     child: Text(
//                       AppLocalizations.of(context).RActivityManagement,
