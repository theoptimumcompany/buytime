...
class ExternalServiceItem extends StatefulWidget {
  ...
  String title;
  bool fromBusiness;
  ExternalServiceItem(this.serviceState, this.fromBusiness, this.serviceList, this.title);
    ...
    return Container(
        ...
        child: Material(
            ...
            child: InkWell(
              ...
              onTap: () async {
                Navigator.push(context, EnterExitRoute(enterPage: ExternalServiceDetails(serviceState: widget.serviceState), exitPage: widget.fromBusiness ? ExternalBusinessDetails(businessState: BusinessState(), fromMy: false,): PAServiceList(widget.serviceList, widget.title), from: true));
