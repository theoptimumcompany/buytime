...
class UI_M_EditCategoryState extends State<UI_M_EditCategory> {
  ...
  void setHeightBookingBlock() {
    setState(() {
      switch (bookingController.index) {
        case 0:
          heightBookingBlock =
              (250 + numberIntervalAvailability.toDouble() * 50).toDouble();
          break;
        case 1:
        ...
        case 2:
          heightBookingBlock =
              (730 + numberCalendarIntervalAvailability.toDouble() * 50)
                  .toDouble();
          break;
      }
    });
  ...
  void initState() {
    super.initState();
    bookingController = TabController();
    heightBookingBlock =
        (250 + numberIntervalAvailability.toDouble() * 50).toDouble();
  ...
  List<Widget> getTabs(Size media) {
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                        width: 2, color: BuytimeTheme.BackgroundLightGrey),
                  ...
                  child: Padding(
                    padding: const EdgeInsets.symmetric(
                        vertical: 10.0, horizontal: 20.00),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Icon(Icons.add,
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.symmetric(
                        vertical: 15.0, horizontal: 20.00),
                    child: Center(
                      child: Text(
                        "SAVE", //todo: lang
                        textAlign: TextAlign.start,
    ...
    tabList.add(Column(
      children: [
        ...
        weekSwitchDay(media, 0, weekSwitch[0], 'Monday'), //todo: lang
        weekSwitchDay(media, 1, weekSwitch[1], 'Tuesday'), //todo: lang
        weekSwitchDay(media, 2, weekSwitch[2], 'Wednesday'), //todo: lang
        weekSwitchDay(media, 3, weekSwitch[3], 'Thursday'), //todo: lang
        weekSwitchDay(media, 4, weekSwitch[4], 'Friday'), //todo: lang
        weekSwitchDay(media, 5, weekSwitch[5], 'Saturday'), //todo: lang
        weekSwitchDay(media, 6, weekSwitch[6], 'Sunday'), //todo: lang
        Padding(
          padding: const EdgeInsets.symmetric(vertical: 0.0, horizontal: 0.0),
          child: Container(
            child: Row(
  ...
  Widget weekSwitchDay(
      Size media, int indexWeekSwitch, bool switchDay, String dayName) {
    return Row(
      // mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Padding(
          padding: EdgeInsets.only(
              left: media.width * 0.05, right: media.width * 0.07),
          child: Container(
            child: Padding(
              ...
              child: Switch(
                  ...
                  onChanged: (value) {
                    setState(() {
                      weekSwitch[indexWeekSwitch] = value;
                    });
                  }),
            ),
          ),
